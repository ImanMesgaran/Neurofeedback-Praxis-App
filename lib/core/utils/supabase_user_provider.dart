...
import 'package:neurofeedback_praxis_app/core/utils/base_auth_user_provider.dart';
import 'package:rxdart/rxdart.dart';
import 'package:supabase_flutter/supabase_flutter.dart';

class PraxisSupabaseUser extends BaseAuthUser {
  PraxisSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> spherSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = PraxisSupabaseUser(authState?.session?.user);
